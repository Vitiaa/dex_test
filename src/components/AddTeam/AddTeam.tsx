...
import { addImage } from "../../store/image/asyncActions";

import { useSelector } from "react-redux";

const AddTeam: React.FC = () => {
  const { register, handleSubmit, watch } = useForm<TeamInterface>();
        ...
        <AddTeamForm onSubmit={handleSubmit(onSubmit)}>
          <AddTeamWrapper>
            ...
            <RightAuthWrap>
              ...
              <Input ref={register} name="division" type="text" />
              <Input ref={register} name="conference" type="text" />
              <Input ref={register} name="foundationYear" type="text" />
